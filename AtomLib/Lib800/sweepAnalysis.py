...
E_path=os.path.join(fol_path,'Lib800sweep_E.txt')
T_path=os.path.join(fol_path,'Lib800sweep_T.txt')
fEnew = open('Circle/500nmAl2O3sweepTE/Enew.txt','w')
...
print(T.shape)
plt.figure(1)
plt.imshow(np.abs(T),vmin=0.00000,vmax=0.00001,cmap='jet',extent=[30,250,1500,500],aspect='auto')
plt.colorbar()
...
outT_path = os.path.join(fol_path,'SweepT800.txt')
outPhase_path=os.path.join(fol_path,'SweepPhase800.txt')
