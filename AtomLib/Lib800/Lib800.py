# 3D meta-atom Library Simulation
# Period = 800nm
# Ping-Yen
import S4
import numpy as np
...
# H_atom sweep loop
for h in range (500,1200,10):
    print('H_atom = '+str(h)+'nm')
    tmid1 = time.time() # timer of each height loop
    for hole_radius_nm in range(100,350,2):
        ...
        S.SetMaterial(Name = 'a-Si', Epsilon = 3.52**2) # From Ellipsometer       
