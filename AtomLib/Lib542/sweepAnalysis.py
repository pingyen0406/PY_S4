...
E_path=os.path.join(fol_path,'Lib542sweep_E.txt')
T_path=os.path.join(fol_path,'Lib542sweep_T.txt')
fEnew = open('60nmAl2O3sweepTE/Enew.txt','w')
...
plt.colorbar()
plt.savefig(os.path.join(fol_path,'SweepPhase.png'))
"""
E_tmp=[]
T_tmp=[]
...
outT_path = os.path.join(fol_path,'SweepT562.txt')
outPhase_path=os.path.join(fol_path,'SweepPhase562.txt')
