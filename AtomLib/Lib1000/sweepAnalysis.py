...
for line in E:
    ...
    count+=1
plt.figure(2)
plt.imshow(phase,cmap='jet',extent=[100,450,1500,500],aspect='auto')
plt.colorbar()
...
outT_path = os.path.join(fol_path,'SweepT1000.txt')
outPhase_path=os.path.join(fol_path,'SweepPhase1000.txt')
