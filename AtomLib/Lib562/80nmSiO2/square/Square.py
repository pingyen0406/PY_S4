...
fol_path = script_dir
outf1 = open(os.path.join(fol_path,'80nmSiO2_square_T.txt'),'w')
outf2 = open(os.path.join(fol_path,'80nmSiO2_square_E.txt'),'w')
...
for h in range (500,1500,10):
    ...
    for width_nm in range(100,250,2):
        width = width_nm/1000   # Change unit to um  
        ...
        S.SetMaterial(Name = 'a-Si', Epsilon = 12.4314) # From paper       
